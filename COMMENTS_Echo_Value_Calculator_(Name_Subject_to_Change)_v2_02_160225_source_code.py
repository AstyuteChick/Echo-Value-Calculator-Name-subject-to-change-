...
#Option 2 now actually easy to use with Echo presets!
#Phoebe and Spectro Rover
...
def main():
    ...
    while True:
        ...
        while True:
            ...
            #Handling options that configure stats
            ...
            #Handling data collection and evaluation
