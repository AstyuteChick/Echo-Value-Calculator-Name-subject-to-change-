...
def main():
    ...
    while True:
        ...
        while character_change != 1:
            ...
            else: calculator_mode = "Normal Mode"
            
            option_selected = input("\nEcho Value Calculator - " + calculator_mode + "\nPlease select from one of the following options: "
            ...
            #Handing options requiring no stat configurations. 
            if option_selected == "9" or option_selected == "09":
                calculator_quit()
                character_change = 1
                continue
            
            elif option_selected == "8" or option_selected == "08":
                character_change = 1
                continue
                ...
                if assumption_test == "4":
                    ...
                    while True:
                        try:
                            ...
                            character_cd = float(input("Enter " + char_name + "'s Crit Damage%: ").strip())
            ...
            #Handling options with stat configurations
            if calc_type == "10":
                if stat_med[0] == 8.4:
