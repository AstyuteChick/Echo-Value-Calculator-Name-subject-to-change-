...
class SetMainFrame2(ctk.CTkFrame):
    ...
    def __init__(self, parent, player_char_name, player_calc_mode, instructs):
        ...
        tab2 = ctk.CTkFrame(calc_tabs.tab("Full Evaluation"))
        tab21 = ctk.CTkScrollableFrame(tab2, orientation = "horizontal")
        tab211 = EchoCell(tab2)
        tab212 = EchoCell(tab2)
        tab213 = EchoCell(tab2)
        tab214 = EchoCell(tab2)
        tab215 = EchoCell(tab2)
        ...
        tab2_calc_but.pack(side = "left", expand = True,  fill = "both")
        disp_val_2 = ctk.CTkLabel(tab22, text = "Total Value: ", font = ("Century Gothic", 14))
        disp_val_2.pack(side = "right", expand = True, fill = "both")
...
def main():
    ...
    char_data = [ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar(), 
                 ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar(), ctk.DoubleVar()]
    instructs = ctk.StringVar(value = "Lul")
